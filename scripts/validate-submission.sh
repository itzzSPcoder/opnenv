...
if [ ! -f "$REPO_DIR/openenv.yaml" ]; then
  fail "Missing openenv.yaml at repository root"
  hint "Create openenv.yaml with your env metadata and runtime config."
  stop_at "Step 1"
fi
...
printf "${GREEN}${BOLD}  Your submission looks ready.${NC}\n"
printf "${BOLD}========================================${NC}\n"
printf "\n"
